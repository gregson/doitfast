      ...
      <div class="grid-x grid-padding-x">
        <div class="cell">
          ...
          <form data-abide novalidate>
            ...
            <fieldset>
              <legend>email</legend>
              <input type="email" required value="contact@get.foundation">
            ...
            <fieldset>
              <legend>url</legend>
              <input type="url" required value="https://get.foundation">
              <input type="url" required value="contact@get.foundation">
            </fieldset>
